...
// Will increase value of tail, limited to the [SIZE - 1] position, and then reset back to 0 using modulo the max size
...
// Otherwise, set value of head to the next position, modulo the size of the queue
